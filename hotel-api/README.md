...
Our API is thoroughly documented using [Scramble](https://scramble.dedoc.co/), which automatically generates OpenAPI (Swagger) documentation for all endpoints.

### Features

- **Automatic OpenAPI 3.1.0 Specification:** Up-to-date documentation directly from your code
- **Interactive Documentation UI:** Powered by Stoplight Elements
...
Scramble is pre-configured in the project. If you need to install it manually:
...
The Scramble configuration can be found in `config/scramble.php`. Key features include:
